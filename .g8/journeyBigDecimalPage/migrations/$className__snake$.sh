...
echo "GET        /$className;format="decap"$                  controllers.journeys.$journeyName$.$className$Controller.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /$className;format="decap"$                  controllers.journeys.$journeyName$.$className$Controller.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /change$className$                        controllers.journeys.$journeyName$.$className$Controller.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /change$className$                        controllers.journeys.$journeyName$.$className$Controller.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
