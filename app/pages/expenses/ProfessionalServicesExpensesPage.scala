...
case object ProfessionalServicesExpensesPage extends QuestionPage[Set[ProfessionalServicesExpenses]] {
  ...
  override def toString: String = "professionalServicesExpenses"
}
