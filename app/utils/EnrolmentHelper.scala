...
object EnrolmentHelper {
  ...
  def getEnrolmentValueOpt(checkedKey: String, checkedIdentifier: String, enrolments: Enrolments): Option[String] =
    enrolments.enrolments.collectFirst { case HMRCEnrolment(`checkedKey`, enrolmentIdentifiers, _, _) =>
