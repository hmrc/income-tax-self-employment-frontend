...
class SpecialTaxSitesController @Inject()(override val messagesApi: MessagesApi,
      ...
      formProvider(request.userType)
        ...
        .fold(
          ...
          answer =>
            ...
            } yield Redirect(navigator.nextPage(SpecialTaxSitesPage, redirectMode, updatedUserAnswers, taxYear, businessId))
        )
  }
  ...
  private def handleGatewayQuestion(currentAnswer: Boolean,
    ...
    val redirectMode = request.getValue(SpecialTaxSitesPage, businessId) match {
