    ...
    implicit request =>
      formProvider(request.userType)
        ...
        .fold(
          ...
          value =>
            service
              .persistAnswer(businessId, request.userAnswers, value, BalancingAllowanceAmountPage)
              .map(updatedAnswers => Redirect(navigator.nextPage(BalancingAllowanceAmountPage, mode, updatedAnswers, taxYear, businessId)))
        )
  }
