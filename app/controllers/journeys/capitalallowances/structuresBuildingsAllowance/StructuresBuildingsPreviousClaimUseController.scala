...
@Singleton
class StructuresBuildingsPreviousClaimUseController @Inject() (override val messagesApi: MessagesApi,
                                                               val controllerComponents: MessagesControllerComponents,
                                                               identify: IdentifierAction,
                                                               getData: DataRetrievalAction,
                                                               requireData: DataRequiredAction,
                                                               formProvider: StructuresBuildingsPreviousClaimUseFormProvider,
                                                               service: StructuresBuildingsService,
                                                               view: StructuresBuildingsPreviousClaimUseView)
    ...
    implicit request =>
      formProvider(request.userType)
        ...
        .fold(
          ...
          answer => service.submitAnswerAndRedirect(StructuresBuildingsPreviousClaimUsePage, businessId, request, answer, taxYear, mode)
        )
  }
