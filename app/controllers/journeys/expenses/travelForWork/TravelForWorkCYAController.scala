...
// */
//
//package controllers.journeys.expenses.travelForWork
//
//import controllers.actions._
//import controllers.handleSubmitAnswersResult
//import models.common.Journey.{ExpensesOfficeSupplies, ExpensesTravelForWork}
...
//
//@Singleton
//class TravelForWorkCYAController @Inject() (override val messagesApi: MessagesApi,
...
//    (identify andThen getUserAnswers andThen getJourneyAnswers[TravelForWorkJourneyAnswers](req =>
//      req.mkJourneyNinoContext(taxYear, businessId, ExpensesTravelForWork))
//      andThen requireData) { implicit request =>
//      val user = request.userType
//
//      val summaryList = SummaryListCYA.summaryListOpt(
//        List(
//          TravelForWorkAmountSummary.row(request.userAnswers, taxYear, businessId, user),
//          TravelForWorkDisallowableAmountSummary.row(request.userAnswers, taxYear, businessId, user)
//        )
//      )
//
//      Ok(
//        view(
//          TravelForWorkCYAPage.toString,
//          taxYear,
//          request.user.userType,
//          summaryList,
//          routes.TravelForWorkCYAController.onSubmit(taxYear, businessId)))
//    }
//
...
//      val result  = service.submitAnswers[TravelForWorkJourneyAnswers](context, request.userAnswers)
//
