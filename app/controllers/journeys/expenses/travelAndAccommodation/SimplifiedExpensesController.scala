...
import views.html.journeys.expenses.travelAndAccommodation.SimplifiedExpenseView
      ...
      form
        ...
        .fold(
          ...
          value =>
            ...
            } yield Redirect(navigator.nextPage(SimplifiedExpensesPage, mode, updatedAnswers))
        )
  }
}
