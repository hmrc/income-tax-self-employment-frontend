...
class WorkFromHomeController @Inject() (override val messagesApi: MessagesApi,
    ...
    with I18nSupport {
  private val page = WorkFromHomePage
        ...
        .fold(
          ...
          value =>
            selfEmploymentService
              .persistAnswer(businessId, request.userAnswers, value, WorkFromHomePage)
              .map(updatedAnswers => Redirect(navigator.nextPage(WorkFromHomePage, mode, updatedAnswers, taxYear, businessId)))
        )
  }
