        ...
        .fold(
          ...
          value =>
            selfEmploymentService
              .persistAnswer(businessId, request.userAnswers, value, EntertainmentCostsPage)
              .map(updatedAnswers => Redirect(navigator.nextPage(EntertainmentCostsPage, mode, updatedAnswers, taxYear, businessId)))
        )
  }
