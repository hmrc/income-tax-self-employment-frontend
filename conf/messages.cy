...
nonTurnoverIncomeAmount.title.individual = How much non-turnover income did you get? //TODO this slide does not appear on the CYA page
...
turnoverIncomeAmount.l4.individual = money owed to you for work already done //TODO these are accruals only
turnoverIncomeAmount.l4.agent = money owed to your client for work already done //TODO these are accruals only
...
otherIncomeAmount.error.lessThanZero.agent = The amount of other self-employment income you got must be more than £0
...
howMuchTradingAllowance.maximum = The maximum £{0} //TODO £1000 or turnover income
howMuchTradingAllowance.lessThan = Less than £{0}
howMuchTradingAllowance.error.required.individual = Select if you wants to use the full trading allowance of £{0} or less than £{0}
...
tradingAllowanceAmount.error.overTurnover.individual = The amount of trading allowance you want to use must be less than {0} // TODO turnover income amount
