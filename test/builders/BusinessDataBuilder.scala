...
object BusinessDataBuilder {
  ...
  val aBusinessData: Seq[BusinessData] = Seq(
    BusinessData(businessId = "SJPR05893938418", typeOfBusiness = "self-employment", tradingName = Some("Trade one"), yearOfMigration = Some("2022"),
    ...
    BusinessData(businessId = "SJPR05893938418", typeOfBusiness = "self-employment", tradingName = Some("Trade two"), yearOfMigration = Some("2022"),
      accountingPeriods = Seq(AccountingPeriod("2023-0x2-29", "2024-0x2-29")),
      firstAccountingPeriodStartDate = Some("2019-09-30"), firstAccountingPeriodEndDate = Some("2020-02-29"),
      latencyDetails = Some(LatencyDetails("2020-02-27", "2019", "A", "2020", "A")),
      accountingType = Some("ACCRUAL"), commencementDate = Some("2023-04-06"), cessationDate = Some("2024-04-05"),
  ...
  val aBusinessDataNoneTradeNames: Seq[BusinessData] = Seq(
    BusinessData(businessId = "SJPR05893938418", typeOfBusiness = "self-employment", tradingName = None, yearOfMigration = Some("2022"),
      accountingPeriods = Seq(AccountingPeriod("2023-0x2-29", "2024-0x2-29")),
      firstAccountingPeriodStartDate = Some("2019-09-30"), firstAccountingPeriodEndDate = Some("2020-02-29"),
      latencyDetails = Some(LatencyDetails("2020-02-27", "2019", "A", "2020", "A")),
      accountingType = Some("ACCRUAL"), commencementDate = Some("2023-04-06"), cessationDate = Some("2024-04-05"),
