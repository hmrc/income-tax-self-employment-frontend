...
class GoodsToSellOrUsePageSpec extends PlaySpec with MockitoSugar {

  "GoodsToSellOrUsePage" should {

    "return the correct string" in {
      GoodsToSellOrUsePage.toString mustBe "goodsToSellOrUse"
    }

    "return the correct pages when no" in {
      GoodsToSellOrUsePage.dependentPagesWhenNo mustBe List(
