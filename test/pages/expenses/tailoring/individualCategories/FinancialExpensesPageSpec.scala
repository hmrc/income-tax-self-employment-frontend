...
class FinancialExpensesPageSpec extends PlaySpec with MockitoSugar {

  "FinancialExpensesPage" should {

    "return the correct string" in {
      FinancialExpensesPage.toString mustBe "financialExpenses"
    }

    "return the correct pages when no" in {
      FinancialExpensesPage.dependentPagesWhenNo mustBe List(
