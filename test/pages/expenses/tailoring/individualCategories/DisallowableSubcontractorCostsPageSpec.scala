...
class DisallowableSubcontractorCostsPageSpec extends PlaySpec with MockitoSugar {
  ...
  "DisallowableSubcontractorCostsPage" should {

    "return the correct string" in {
      DisallowableSubcontractorCostsPage.toString mustBe "disallowableSubcontractorCosts"
    }

    "return the correct pages when no" in {
      DisallowableSubcontractorCostsPage.dependentPagesWhenNo mustBe List(ConstructionIndustryAmountPage, ConstructionIndustryDisallowableAmountPage)
    }
