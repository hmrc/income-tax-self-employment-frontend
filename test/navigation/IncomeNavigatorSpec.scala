    ...
    "in Normal mode" - {
      ...
      "Income Not Counted As Turnover Page must go to the" - {
        ...
        "Turnover Income Amount page when answer is 'No'" in {
          ...
          val userAnswers = UserAnswers(userAnswersId).set(IncomeNotCountedAsTurnoverPage, false).success.value
      ...
      "AnyOtherIncomePage must go to the" - {
        ...
        "Turnover Not Taxable page when answer is 'No' and accounting type is 'ACCRUAL'" in {
          ...
          val userAnswers = UserAnswers(userAnswersId).set(AnyOtherIncomePage, false).success.value
      ...
      "Turnover Not Taxable Page must go to the" - {
        ...
        "Trading Allowance page when answer is 'No'" in {
          ...
          val userAnswers = UserAnswers(userAnswersId).set(TurnoverNotTaxablePage, false).success.value
      ...
      "Trading Allowance Page must go to the How Much Trading Allowance page" in {

        navigator.nextPage(TradingAllowancePage, NormalMode, UserAnswers("id"), taxYear, businessId) mustBe
          HowMuchTradingAllowanceController.onPageLoad(taxYear, businessId, NormalMode)
      }

      "How Much Trading Allowance Page must go to the Trading Allowance Amount page" in {

        navigator.nextPage(HowMuchTradingAllowancePage, NormalMode, UserAnswers("id"), taxYear, businessId) mustBe
