...
class WorkingFromHomeHoursFormProviderSpec extends IntFieldBehaviours {
  ...
  private val nonNumericError         = "workingFromHomeHours.error.nonNumeric"
  private val noDecimalsError         = "workingFromHomeHours.error.noDecimals"
  private val lessThanZeroError       = "workingFromHomeHours.error.lessThanZero"
