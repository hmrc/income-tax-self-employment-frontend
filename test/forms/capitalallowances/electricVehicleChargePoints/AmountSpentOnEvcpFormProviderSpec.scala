...
class AmountSpentOnEvcpFormProviderSpec extends BigDecimalFieldBehaviours with MoneyBounds {

  val minimumVal: BigDecimal   = minimumValue
  val maximumVal: BigDecimal   = maxAmountValue
  val requiredError: String    = "amountSpentOnEvcp.error.required"
  ...
  "AmountSpentOnEvcpFormProvider should" - {
    val form: Form[BigDecimal] = new AmountSpentOnEvcpFormProvider()(userType)
