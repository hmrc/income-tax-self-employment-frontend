...
class EvcpHowMuchDoYouWantToClaimSummarySpec extends SummaryBaseSpec("EvcpHowMuchDoYouWantToClaimSummary") {

  override val validData: JsObject = Json.obj("evcpClaimAmount" -> 400.00)
