...
class ChargePointTaxReliefSummarySpec extends SummaryBaseSpec("ChargePointTaxReliefSummary") {

  override val validData: JsObject = Json.obj("chargePointTaxRelief" -> true)
