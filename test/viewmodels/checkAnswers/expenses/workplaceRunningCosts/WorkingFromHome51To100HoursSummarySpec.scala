...
class WorkingFromHome51To100HoursSummarySpec extends SummaryBaseSpec("WorkingFromHome51To100HoursSummary") {

  private val amount: Int = 1

  override val validData: JsObject   = Json.obj("wfhHours51To100" -> amount)
