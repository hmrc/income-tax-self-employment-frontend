...
class IrrecoverableDebtsAmountSummarySpec extends SummaryBaseSpec("IrrecoverableDebtsAmountSummary") {
  ...
  override val testKey: UserType => Text = (userType: UserType) => Text(s"irrecoverableDebtsAmount.title.$userType")
  override val testValue: Text           = Text(s"£${formatMoney(amount)}")

  override def buildSummaryListRow(userAnswers: UserAnswers, userType: UserType): Option[SummaryListRow] =
    IrrecoverableDebtsAmountSummary.row(userAnswers, taxYear, businessId, userType)(messages)
