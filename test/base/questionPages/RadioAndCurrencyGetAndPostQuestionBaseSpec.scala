...
abstract case class RadioAndCurrencyGetAndPostQuestionBaseSpec[A, B](controller: String, page: Page) extends ControllerSpec {

  def validCurrencyAmount: BigDecimal
  def validRadioAnswer: B
