...
import models.{NormalMode, UserAnswers, disallowableIndustryCosts}
...
class disallowableIndustryCostsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val disallowableIndustryCostsRoute = routes.disallowableIndustryCostsController.onPageLoad(NormalMode).url
