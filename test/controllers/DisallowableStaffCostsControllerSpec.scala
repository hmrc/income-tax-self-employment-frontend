...
import models.{NormalMode, DisallowableStaffCosts, UserAnswers}
...
import views.html.DisallowableStaffCostsView
...
class DisallowableStaffCostsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val disallowableStaffCostsRoute = routes.DisallowableStaffCostsController.onPageLoad(NormalMode).url
