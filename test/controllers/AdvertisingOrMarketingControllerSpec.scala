...
import models.{NormalMode, AdvertisingOrMarketing, UserAnswers}
import navigation.{FakeExpensesNavigator, ExpensesNavigator}
import org.mockito.ArgumentMatchers.any
import org.mockito.Mockito.when
import org.scalatestplus.mockito.MockitoSugar
import pages.AdvertisingOrMarketingPage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.AdvertisingOrMarketingView
...
class AdvertisingOrMarketingControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val advertisingOrMarketingRoute = routes.AdvertisingOrMarketingController.onPageLoad(NormalMode).url
