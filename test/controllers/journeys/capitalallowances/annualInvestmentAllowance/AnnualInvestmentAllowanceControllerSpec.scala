...
class AnnualInvestmentAllowanceControllerSpec
    extends BooleanGetAndPostQuestionBaseSpec("AnnualInvestmentAllowanceController", AnnualInvestmentAllowancePage) {
