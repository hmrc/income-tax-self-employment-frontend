...
class BalancingChargeControllerSpec extends BooleanGetAndPostQuestionBaseSpec("BalancingChargeController", BalancingChargePage) {

  override def onPageLoadCall: Call = routes.BalancingChargeController.onPageLoad(taxYear, businessId, NormalMode)
  override def onSubmitCall: Call   = routes.BalancingChargeController.onSubmit(taxYear, businessId, NormalMode)
