...
class ZecHowMuchDoYouWantToClaimControllerSpec extends ControllerSpec {
  ...
  private val fullCost: BigDecimal                         = 5000
  ...
  private def baseAnswers: UserAnswers = emptyUserAnswersAccrual
    ...
    .success
    .value // TODO 7205 uncomment these lines
//    .set(ZecUseOutsideSEPercentagePage, 0, businessId.some)
//    .success
//    .value
  ...
  private def expectedView(expectedForm: Form[ZecHowMuchDoYouWantToClaimModel], scenario: TestScenario)(implicit
    ...
    view(expectedForm, scenario.mode, scenario.userType, scenario.taxYear, scenario.businessId, fullCost).toString()
  }
