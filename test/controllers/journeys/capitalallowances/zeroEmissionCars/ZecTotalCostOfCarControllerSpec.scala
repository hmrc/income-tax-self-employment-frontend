...
class ZecTotalCostOfCarControllerSpec
    extends BigDecimalGetAndPostQuestionBaseSpec(
      "ZecTotalCostOfCarController",
  ...
  override def createForm(userType: UserType): Form[BigDecimal] = new ZecTotalCostOfCarFormProvider()(userType)

  override def expectedView(form: Form[_], scenario: TestScenario)(implicit
      request: Request[_],
      messages: Messages,
      application: Application): String = {
    val view = application.injector.instanceOf[ZecTotalCostOfCarView]
