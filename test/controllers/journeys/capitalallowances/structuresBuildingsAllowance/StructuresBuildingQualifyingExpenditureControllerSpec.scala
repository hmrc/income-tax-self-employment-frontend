...
import views.html.journeys.capitalallowances.structuresBuildingsAllowance.StructuresBuildingQualifyingExpenditureView

class StructuresBuildingQualifyingExpenditureControllerSpec
    extends BigDecimalGetAndPostQuestionBaseSpec("StructuresBuildingQualifyingExpenditureController", StructuresBuildingsQualifyingExpenditurePage) {

  override def onPageLoadRoute: String = routes.StructuresBuildingQualifyingExpenditureController.onPageLoad(taxYear, businessId, 0, NormalMode).url

  override def onSubmitRoute: String = routes.StructuresBuildingQualifyingExpenditureController.onSubmit(taxYear, businessId, 0, NormalMode).url
  ...
  override def expectedView(form: Form[_], scenario: TestScenario)(implicit
    ...
    val view = application.injector.instanceOf[StructuresBuildingQualifyingExpenditureView]
