...
import controllers.journeys.expenses.routes.DisallowableOtherFinancialChargesController
...
import views.html.journeys.expenses.DisallowableOtherFinancialChargesView
...
class DisallowableOtherFinancialChargesControllerSpec extends SpecBase with MockitoSugar {
  ...
  "DisallowableOtherFinancialCharges Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        UserAnswers(userAnswersId).set(DisallowableOtherFinancialChargesPage, DisallowableOtherFinancialCharges.values.head).success.value
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill(DisallowableOtherFinancialCharges.values.head), NormalMode)(
          request,
