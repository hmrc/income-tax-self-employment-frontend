...
class SimplifiedExpensesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val simplifiedExpensesRoute = routes.SimplifiedExpensesController.onPageLoad(NormalMode).url
  ...
  "SimplifiedExpenses Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, simplifiedExpensesRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, simplifiedExpensesRoute)
