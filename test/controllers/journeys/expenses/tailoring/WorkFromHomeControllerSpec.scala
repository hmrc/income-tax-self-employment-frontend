...
import controllers.journeys.expenses.tailoring.routes.WorkFromHomeController
import controllers.standard.routes.JourneyRecoveryController
import forms.expenses.tailoring.WorkFromHomeFormProvider
...
import pages.expenses.tailoring.WorkFromHomePage
...
class WorkFromHomeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val workFromHomeRoute = WorkFromHomeController.onPageLoad(taxYear, businessId, NormalMode).url
