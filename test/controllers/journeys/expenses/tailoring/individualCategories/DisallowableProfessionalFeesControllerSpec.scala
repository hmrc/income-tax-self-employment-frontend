...
class DisallowableProfessionalFeesControllerSpec extends SpecBase with MockitoSugar with BeforeAndAfterEach {

  implicit val messages: Messages = messagesStubbed

  def onwardRoute: Call = Call("GET", "/foo")

  lazy val disallowableProfessionalFeesRoute: String =
