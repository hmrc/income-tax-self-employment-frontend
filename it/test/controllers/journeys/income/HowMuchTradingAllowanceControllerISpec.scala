...
class HowMuchTradingAllowanceControllerISpec extends WiremockSpec with IntegrationBaseSpec {

  val url: String       = routes.HowMuchTradingAllowanceController.onPageLoad(taxYear, businessId, NormalMode).url
  val submitUrl: String = routes.HowMuchTradingAllowanceController.onSubmit(taxYear, businessId, NormalMode).url
  ...
  "GET /:taxYear/:businessId/income/trading-allowance/under-1000" when {
  ...
  "POST /:taxYear/:businessId/income/trading-allowance/under-1000" when {
