...
class AnyOtherIncomeControllerISpec extends WiremockSpec with IntegrationBaseSpec {

  val url: String       = routes.AnyOtherIncomeController.onPageLoad(taxYear, businessId, NormalMode).url
  val submitUrl: String = routes.AnyOtherIncomeController.onSubmit(taxYear, businessId, NormalMode).url

  "GET /:taxYear/:businessId/income/other-income" when {
  ...
  "POST /:taxYear/:businessId/income/other-income" when {
