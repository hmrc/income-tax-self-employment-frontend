...
class AdjustmentsSummaryControllerISpec extends WiremockSpec with IntegrationBaseSpec {

  private val url: String = routes.AdjustmentsSummaryController.onPageLoad(taxYear, businessId).url

  private val testContext: JourneyAnswersContext = JourneyAnswersContext(taxYear, nino, businessId, mtditid, AdjustmentsPrepop)

  "GET /:taxYear/:businessId/adjustments/prepop" when {
